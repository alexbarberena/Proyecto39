...
function preload(){
  ...
  fondo =loadImage("611323006.jpeg")
}
...
function setup() {
  ...
  gameOver = createSprite(trex.x+100,100);
  gameOver.addImage(gameOverImg);
  
  restart = createSprite(trex.x+100,140);
...
function draw() {
  ...
  text("Puntuación: "+ score, trex.x+100,50);
  
  text("Tu vida es "+ vida, trex.x+100,30);
